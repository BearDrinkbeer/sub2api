...
// WindowsADSyntheticEmailDomain 是 Windows AD 用户在目录未返回邮箱时的合成邮箱后缀（RFC 保留域名）。
const WindowsADSyntheticEmailDomain = "@windows-ad.invalid"
...
const (
	...
	// Windows AD 域登录设置
	SettingKeyWindowsADEnabled           = "windows_ad_enabled"
	...
	SettingKeyWindowsADGroupSearchBase   = "windows_ad_group_search_base"
	...
	SettingKeyWindowsADEmailAttribute    = "windows_ad_email_attribute"
	SettingKeyWindowsADUsernameAttribute = "windows_ad_username_attribute"
	SettingKeyWindowsADDisplayAttribute  = "windows_ad_display_attribute"
	SettingKeyWindowsADIDAttribute       = "windows_ad_id_attribute"
	SettingKeyWindowsADStartTLS          = "windows_ad_start_tls"
	SettingKeyWindowsADSkipTLSVerify     = "windows_ad_skip_tls_verify"
	...
	SettingKeyAuthSourceDefaultWindowsADBalance          = "auth_source_default_windows_ad_balance"
	SettingKeyAuthSourceDefaultWindowsADConcurrency      = "auth_source_default_windows_ad_concurrency"
	SettingKeyAuthSourceDefaultWindowsADSubscriptions    = "auth_source_default_windows_ad_subscriptions"
	SettingKeyAuthSourceDefaultWindowsADGrantOnSignup    = "auth_source_default_windows_ad_grant_on_signup"
	SettingKeyAuthSourceDefaultWindowsADGrantOnFirstBind = "auth_source_default_windows_ad_grant_on_first_bind"
